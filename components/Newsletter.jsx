...
export const Newsletter = () => {
  return (
    <div className="container flex flex-wrap bg-pink p-7 rounded-xl relative mx-auto -top-16 sm:-top-8 w-11/12 sm:w-full shadow-xl">
      <h2 className="text-white text-2xl sm:text-3xl text-center font-bold basis-full lg:basis-1/2 self-center">
      ...
      <div className="flex flex-wrap justify-center sm:flex-nowrap w-full lg:w-1/2 text-center items-center py-6 mt-4 sm:p-2 px-4">
        ...
        />
        <button className="sm:w-56 xl:w-1/3 text-white bg-pink border-white hover:bg-white hover:text-pink border-2 rounded-full px-8 py-3 shadow-xl">
          Inscreva-se
        </button>
      </div>
    </div>
